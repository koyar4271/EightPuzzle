...
public class AStar15h1 {
    ...
    private static final int NODE_LIMIT = 10000000; // ノードの上限を設定
    ...
    private static void solve(int[][] initialState) {
        ...
        while (!openList.isEmpty()) {
            ...
            if (searchCost > NODE_LIMIT) {
                System.out.println("Node limit exceeded. Search cost: " + searchCost);
                return;
            }
            ...
            if (isGoal(currentNode.state)) {
                System.out.println("Solution found with cost: " + searchCost);
